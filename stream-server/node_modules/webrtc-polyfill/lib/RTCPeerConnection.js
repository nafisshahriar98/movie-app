...
export default class RTCPeerConnection extends EventTarget {
  ...
  constructor (init = {}) {
    ...
    RTCPeerConnection.#instanceCount++
  ...
  close () {
    try {
      ...
      RTCPeerConnection.#instanceCount--
      if (!RTCPeerConnection.#instanceCount) cleanup()
    }
  }
  ...
  async setLocalDescription (description) {
    ...
    if (
      (type === 'offer' && state === 'stable') ||
      (type === 'answer' && state === 'have-remote-offer') ||
      (type === 'pranswer' && state === 'have-remote-offer')
    ) {
  ...
  async setRemoteDescription (description) {
    ...
    const state = this.signalingState
    if (
      (description.type === 'offer' && state === 'stable') ||
      (description.type === 'answer' && state === 'have-local-offer') ||
      (description.type === 'pranswer' && state === 'have-local-offer')
    ) {
